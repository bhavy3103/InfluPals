...
-- Making recentposts and demographics key AUTO INC
ALTER TABLE mad.creator DROP FOREIGN KEY creator_ibfk_2;
ALTER TABLE `recentposts` CHANGE `id` `id` BIGINT(18) NOT NULL AUTO_INCREMENT;
ALTER TABLE mad.creator ADD CONSTRAINT creator_ibfk_2 FOREIGN KEY (id) REFERENCES recentposts(id);
ALTER TABLE mad.creator DROP FOREIGN KEY creator_ibfk_1;
ALTER TABLE `demographics` CHANGE `id` `id` BIGINT(20) NOT NULL AUTO_INCREMENT;
ALTER TABLE mad.creator ADD CONSTRAINT creator_ibfk_1 FOREIGN KEY (id) REFERENCES demographics(id);

-- Added like_count and comments_count in Post table
ALTER TABLE `post` ADD `like_count` INT NOT NULL DEFAULT '0' AFTER `url`, ADD `comments_count` INT NOT NULL DEFAULT '0' AFTER `like_count`;
